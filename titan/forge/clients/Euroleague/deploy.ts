...
const deploy = async () => {
    ...
    try {
        // Deploy a new EscrowERC721_v1 contract.
        const marketplace: ethers.Contract = await collections.clancy.marketplace.escrow.EscrowERC721_v1.deploy(VALID_CONTRACTS.EscrowERC721_v1)
