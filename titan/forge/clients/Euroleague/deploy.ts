...
const deploy = async () => {
    ...
    try {
        ...
        const marketplace: ethers.Contract = await collections.clancy.marketplace.escrow.EscrowERC721.deploy(VALID_CONTRACTS.EscrowERC721)
        ...
        await collections.clancy.marketplace.setVendorStatus(marketplace, reels, true, VALID_CONTRACTS.EscrowERC721)
        ...
        for (const series1case of Object.values(series1cases)) {
            ...
            await collections.clancy.marketplace.setVendorStatus(marketplace, series1case, true, VALID_CONTRACTS.EscrowERC721)
        }
